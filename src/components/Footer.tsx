        ...
        <div className={styles.grid}>
          ...
          <div className={styles.brand}>
            ...
            <p className={styles.brandDesc}>
              İstanbul Anadolu Yakası&apos;nın tüm ilçelerinde profesyonel halı yıkama,
              yerinde koltuk yıkama ve araç koltuk temizliği hizmetleri.
            </p>
            <div className={styles.socials}>
              ...
              <a href={siteConfig.phoneHref} className={styles.phoneLink} aria-label="Telefon">
                <PhoneIcon />
              </a>
              <a
                href={whatsappUrl}
          ...
          <div>
            ...
            <p className={styles.regionNote}>İstanbul Anadolu Yakası — Tüm İlçeler</p>
          ...
          <div>
            ...
            <div className={styles.ctaRow}>
              <a href={siteConfig.phoneHref} className={styles.ctaCall}>Hemen Ara</a>
              <a href={whatsappUrl} className={styles.ctaWa} target="_blank" rel="noopener noreferrer">WhatsApp</a>
            </div>
          </div>
        </div>
