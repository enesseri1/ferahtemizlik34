...
export default function CTABlock({
  ...
  description = "İstanbul Anadolu Yakası'nın tüm ilçelerinde yerinde koltuk yıkama ve halı yıkama hizmeti için hemen bizi arayın. Ücretsiz keşif ve fiyat bilgisi.",
}: CTABlockProps) {
      ...
      <div className="container">
        <div className={styles.inner}>
          ...
          <div className={styles.buttons}>
            <a href={siteConfig.phoneHref} className={styles.btnCall}>
            ...
            <a href={whatsappUrl} className={styles.btnWa} target="_blank" rel="noopener noreferrer">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
